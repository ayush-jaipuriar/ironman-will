...
Stack
- Spring Boot 3.x (Web, Security 6, OAuth2 Client, Data JPA, Validation)
- Postgres 15 (Cloud SQL), GCS for proofs
- JSON logging; optional Bucket4j rate limiting; request ID filter
